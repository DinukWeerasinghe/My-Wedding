...
function EnvelopeIntro({ hidden, onEnter }) {
  return (
    <section className={`intro-envelope ${hidden ? "is-hidden" : ""}`} id="introEnvelope" aria-label="Opening wedding envelope animation">
      {/* ENVELOPE VIDEO REPLACEMENT POINT:
        If you have a custom envelope opening video, replace the CSS envelope below with a video element.
      */}
    ...
    <section className="section gallery-section" id="gallery" aria-labelledby="galleryTitle">
      <div className="section-inner">
        ...
        <div className="gallery-grid">
          {/* GALLERY PHOTOS: Replace these placeholder image URLs with your couple photos or invitation card images. */}
          {galleryImages.map((image) => (
            <figure className="gallery-card reveal" key={image.src}>
